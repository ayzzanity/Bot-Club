...
Func _DraftClicks($GameHandle) ;Draft Board Clicks
	;first row
...
Func _ShardClicks($GameHandle) ;RD Shards Clicks
	;first row
...
Func _RDControlDrag($GameHandle) ;RD Cards Drag
	;first card
...
Func _PlayRoadToGlory($GameHandle)
