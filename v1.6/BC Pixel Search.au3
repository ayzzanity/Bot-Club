...
Func _WildModePixels($GameHandle)
...
Func _RingDominationPixels($GameHandle)
...
Func _RoadToGloryPixels($GameHandle, $dX, $dY)
...
Func _TeamRingDominationPixels($GameHandle)
...
Func _TrainingCardPixels($GameHandle)
...
Func _GeneralPixels($GameHandle)
