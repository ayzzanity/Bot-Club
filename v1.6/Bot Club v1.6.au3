...
#RequireAdmin
#include-once
#include <BC Actions.au3>
#include <BC Global Variables.au3>
#include <BC GUI Design.au3>
#include <BC Misc Functions.au3>
#include <BC Pixel Search.au3>

#Region ;**** Directives created by AutoIt3Wrapper_GUI ****
#AutoIt3Wrapper_Icon=..\..\WWE Superbot\images\gui\sc.ico
#AutoIt3Wrapper_Compile_Both=y
#AutoIt3Wrapper_UseX64=y
#AutoIt3Wrapper_Res_Description=WWE Supercard's Auto Clicking Bot
...
Func WildMode()
	While ($StartWild)
		_WildModePixels($GameHandle)
		_GeneralPixels($GameHandle)
...
Func RoadToGlory()
	...
	While ($StartRTG)
		...
		_RoadToGloryPixels($GameHandle, $dX, $dY)
		_GeneralPixels($GameHandle)
...
Func RingDomination()
	While ($StartRD)
		_RingDominationPixels($GameHandle)
		_GeneralPixels($GameHandle)
...
Func TeamRingDomination()
	Local $DCounter = 0
	While ($StartTRD)
		_TeamRingDominationPixels($GameHandle)
		_GeneralPixels($GameHandle)
...
Func TrainCards()
	...
	While ($Training)
		_TrainingCardPixels($GameHandle)
		;look for card list
