...
#Region /========== GUI Design ==========/
Func CreateGUI()
	Global $SCBot = GUICreate("The Bot Club v1.6b", 281, 332, -1, -1)
	...
	GUICtrlSetData(-1, "Select Game Mode...|Training Test|Wild Mode|War Mode|Royal Rumble|Womens Royal Rumble|Elimination Chamber|Money in the Bank|Ring Domination|Road to Glory|Last Man Standing|[Team]Ring Domination|[Team]Road to Glory", "Select Game Mode...")
	Global $lblHandle = GUICtrlCreateLabel("====SELECT EMULATOR=====", 48, 72, 197, 20)
	GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
	Global $cboHandle = GUICtrlCreateCombo("", 48, 96, 185, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	GUICtrlSetData(-1, "Emulator List...","Emulator List...")
